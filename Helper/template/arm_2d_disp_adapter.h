...
//     <0=>     None
//     <1=>     Monochrome
// <i> When specifying a colour solution, the __DISP%Instance%_CFG_COLOUR_DEPTH__ and other corresponding options will be configured (overriden) accordingly.
#ifndef __DISP%Instance%_CFG_COLOR_SOLUTION__
#   define __DISP%Instance%_CFG_COLOR_SOLUTION__                            0
#endif
...
#   define __DISP%Instance%_CFG_PFB_BLOCK_HEIGHT__                          24
#endif
...
#ifndef __DISP%Instance%_CFG_DISABLE_DYNAMIC_PFB__
#   define __DISP%Instance%_CFG_DISABLE_DYNAMIC_PFB__                       0
#endif
...
#ifndef __DISP%Instance%_CFG_OPTIMIZE_DIRTY_REGIONS__
#   define __DISP%Instance%_CFG_OPTIMIZE_DIRTY_REGIONS__                    1
#endif

// <o> Dirty Region Pool Size <4-255>
// <i> The number of dirty region items available for the dirty region optimization service
#ifndef __DISP%Instance%_CFG_DIRTY_REGION_POOL_SIZE__
#   define __DISP%Instance%_CFG_DIRTY_REGION_POOL_SIZE__                    8
#endif
...
#   define __DISP%Instance%_CFG_SWAP_RGB16_HIGH_AND_LOW_BYTES__             0
#endif
...
#ifndef __DISP%Instance%_CFG_PFB_ANS_WIDTH__
#   define __DISP%Instance%_CFG_PFB_ANS_WIDTH__                              8
#endif

// <o>The Anti-Noise-Scanning block Height
// <i> The height of the anti-noise-scanning block size
#ifndef __DISP%Instance%_CFG_PFB_ANS_HEIGHT__
#   define __DISP%Instance%_CFG_PFB_ANS_HEIGHT__                             8
#endif
...
#   undef __DISP%Instance%_CFG_COLOUR_DEPTH__
#   define __DISP%Instance%_CFG_COLOUR_DEPTH__                               8
#endif

#ifndef __DISP%Instance%_COLOUR_FORMAT__
#   if      __DISP%Instance%_CFG_COLOUR_DEPTH__ == 8
#       define __DISP%Instance%_COLOUR_FORMAT__  ARM_2D_COLOUR_GRAY8
#   elif    __DISP%Instance%_CFG_COLOUR_DEPTH__ == 16
#       define __DISP%Instance%_COLOUR_FORMAT__  ARM_2D_COLOUR_RGB565
#   elif    __DISP%Instance%_CFG_COLOUR_DEPTH__ == 32
#       define __DISP%Instance%_COLOUR_FORMAT__  ARM_2D_COLOUR_CCCN888
#   endif
#endif
...
#   define __DISP_ADAPTER%Instance%_NANO_DRAW_RESUME_FULL_FLUSH_FLAG__()                 \
        arm_2d_helper_pfb_full_frame_refresh_mode(                              \
                                    ...
                                    DISP%Instance%_ADAPTER.__bTempflag)
#else
#   define __DISP_ADAPTER%Instance%_NANO_DRAW_RESUME_FULL_FLUSH_FLAG__()
#endif
