...
#ifdef __RTE_ACCELERATION_ARM_2D_SCENE_<NAME>__
...
static
IMPL_PFB_ON_DRAW(__pfb_draw_scene_<name>_background_handler)
{
                                        ...
                                        user_scene_<name>_t *ptThis)
{
    ...
    *ptThis = (user_scene_<name>_t){
        .use_as__arm_2d_scene_t = {
             ...
             */
            //.fnBackground   = &__pfb_draw_scene_<name>_background_handler,
