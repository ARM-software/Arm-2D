...
#   define __DISP1_CFG_PFB_BLOCK_WIDTH__   __DISP1_CFG_SCEEN_WIDTH__
#endif

#ifndef __DISP1_CFG_PFB_BLOCK_WIDTH__
#   define __DISP1_CFG_PFB_BLOCK_WIDTH__   __DISP1_CFG_SCEEN_HEIGHT__
#endif
...
IMPL_PFB_ON_DRAW(__pfb_draw_navigation)
{
                    ...
                    (arm_2d_region_t []){
                        {
                            .tLocation = {
                                .iX = 0,
                                .iY = __DISP1_CFG_SCEEN_HEIGHT__ - 17},
                            .tSize = {
    ...
    arm_lcd_text_location( (__DISP1_CFG_SCEEN_HEIGHT__ + 7) / 8 - 2, 
                            (__DISP1_CFG_SCEEN_WIDTH__ / 6) - 22);
