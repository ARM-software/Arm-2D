...
IMPL_PFB_ON_DRAW(__pfb_draw_scene0_handler)
{
    ...
    /*-----------------------draw the foreground begin-----------------------*/
        ...
        arm_2d_align_centre(__top_canvas, 100, 56 ) {
            ...
            arm_2d_layout(__centre_region) {
                ...
                __item_line_dock_vertical(32, 0, 0, 0, 0) {
                    ...
                    arm_lcd_printf_label(ARM_2D_ALIGN_BOTTOM_CENTRE, "CMSIS");
                }
                
                __item_line_dock_vertical(24, 0, 0, 0, 0) {
                    arm_lcd_text_set_target_framebuffer((arm_2d_tile_t *)ptTile);
                    arm_lcd_text_set_font(&ARM_2D_FONT_6x8.use_as__arm_2d_font_t);
                    arm_lcd_text_set_draw_region(&__item_region);
                    arm_lcd_text_set_colour(GLCD_COLOR_WHITE, GLCD_COLOR_BLACK);
                    arm_lcd_printf_label(ARM_2D_ALIGN_TOP_CENTRE, "arm-2d");
                }
            }
