...
#ifndef __ARM_2D_SCENE_FAN_H__
#define __ARM_2D_SCENE_FAN_H__
...
#ifdef __USER_SCENE_FAN_IMPLEMENT__
#   undef __USER_SCENE_FAN_IMPLEMENT__
...
/*!
 * \brief initalize scene_fan and add it to a user specified scene player
 ...
 *            user_scene_fan_t will be allocated from HEAP and freed on
 *            the deposing event. When it is non-NULL, the life-cycle is managed
 *            by user.
 * \return user_scene_fan_t* the user_scene_fan_t instance
 */
#define arm_2d_scene_fan_init(__DISP_ADAPTER_PTR, ...)                    \
            __arm_2d_scene_fan_init((__DISP_ADAPTER_PTR), (NULL, ##__VA_ARGS__))
 ...
 */
typedef struct user_scene_fan_t user_scene_fan_t;

struct user_scene_fan_t {
