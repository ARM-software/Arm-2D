...
static void __on_scene_benchmark_watch_panel_background_start(arm_2d_scene_t *ptScene)
{
    user_scene_benchmark_watch_panel_t *ptThis = (user_scene_benchmark_watch_panel_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene_benchmark_watch_panel_background_complete(arm_2d_scene_t *ptScene)
{
    user_scene_benchmark_watch_panel_t *ptThis = (user_scene_benchmark_watch_panel_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene_benchmark_watch_panel_frame_start(arm_2d_scene_t *ptScene)
{
    user_scene_benchmark_watch_panel_t *ptThis = (user_scene_benchmark_watch_panel_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene_benchmark_watch_panel_frame_complete(arm_2d_scene_t *ptScene)
{
    user_scene_benchmark_watch_panel_t *ptThis = (user_scene_benchmark_watch_panel_t *)ptScene;
    ...
    if (BENCHMARK.wIterations) {
        ...
        if (0 == BENCHMARK.wIterations) {
            ...
            BENCHMARK.wFPS30Score 
                = __arm_2d_helper_benchmark_calculate_fps30score(   (int64_t)BENCHMARK.dwTotal, 
                                                                    ITERATION_CNT);
#endif
            do {
...
static void __before_scene_benchmark_watch_panel_switching_out(arm_2d_scene_t *ptScene)
{
    user_scene_benchmark_watch_panel_t *ptThis = (user_scene_benchmark_watch_panel_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static
IMPL_PFB_ON_DRAW(__pfb_draw_scene_benchmark_watch_panel_handler)
{
                                    ...
                                    user_scene_benchmark_watch_panel_t *ptThis)
{
    ...
    if (NULL == ptThis) {
        ptThis = (user_scene_benchmark_watch_panel_t *)malloc(sizeof(user_scene_benchmark_watch_panel_t));
        assert(NULL != ptThis);
        if (NULL == ptThis) {
            return NULL;
        }
