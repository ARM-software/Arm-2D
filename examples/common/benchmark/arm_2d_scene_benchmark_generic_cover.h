...
#ifndef __ARM_2D_SCENE_BENCHMARK_GENERIC_COVER_H__
#define __ARM_2D_SCENE_BENCHMARK_GENERIC_COVER_H__
...
#ifdef __USER_SCENE_BENCHMARK_GENERIC_COVER_IMPLEMENT__
#   undef __USER_SCENE_BENCHMARK_GENERIC_COVER_IMPLEMENT__
...
/*!
 * \brief initalize benchmark generic and add it to a user specified scene player
 * \param[in] ... this is an optional parameter. When it is NULL, DISP0_ADAPTER
 *                will be used as default.
 * \return user_scene_benchmark_generic_cover_t * the benchmark scene object
 */
 ...
 */
typedef struct user_scene_benchmark_generic_cover_t
        user_scene_benchmark_generic_cover_t;

struct user_scene_benchmark_generic_cover_t {
