...
#ifndef __ARM_2D_SCENE_LMSK_H__
#define __ARM_2D_SCENE_LMSK_H__
...
#ifdef __USER_SCENE_LMSK_IMPLEMENT__
#   define __ARM_2D_IMPL__
#endif
#ifdef __USER_SCENE_LMSK_INHERIT__
#   define __ARM_2D_INHERIT__
#endif
#include "arm_2d_utils.h"

#ifndef ARM_2D_DEMO_LMSK_QOI_USE_FILE
...
/*!
 * \brief initalize scene_lmsk and add it to a user specified scene player
 ...
 *            user_scene_lmsk_t will be allocated from HEAP and freed on
 *            the deposing event. When it is non-NULL, the life-cycle is managed
 *            by user.
 * \return user_scene_lmsk_t* the user_scene_lmsk_t instance
 */
#define arm_2d_scene_lmsk_init(__DISP_ADAPTER_PTR, ...)                    \
            __arm_2d_scene_lmsk_init((__DISP_ADAPTER_PTR), (NULL, ##__VA_ARGS__))

/*============================ TYPES =========================================*/
/*!
 * \brief a user class for scene lmsk
 */
typedef struct user_scene_lmsk_t user_scene_lmsk_t;

struct user_scene_lmsk_t {
...
#undef __USER_SCENE_LMSK_IMPLEMENT__
#undef __USER_SCENE_LMSK_INHERIT__
