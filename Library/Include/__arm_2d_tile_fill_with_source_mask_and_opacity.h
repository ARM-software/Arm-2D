...
#ifndef __ARM_2D_TILE_FILL_WITH_MASK_AND_OPACITY_H__
#define __ARM_2D_TILE_FILL_WITH_MASK_AND_OPACITY_H__
...
#define arm_2d_rgb565_tile_fill_with_src_mask_and_opacity_only(                 \
                                    ...
                                    __REGION,       /*   region address */      \
                                    __OPACITY)      /*   opacity */             \
            arm_2dp_rgb565_tile_fill_with_src_mask_and_opacity_only(            \
                                        NULL,                                   \
                                        (__SRC_ADDR),                           \
                                        (__SRC_MSK_ADDR),                       \
                                        (__DES_ADDR),                           \
