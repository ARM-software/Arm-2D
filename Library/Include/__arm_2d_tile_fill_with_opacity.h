...
#ifndef __ARM_2D_TILE_FILL_WITH_OPACITY_H__
#define __ARM_2D_TILE_FILL_WITH_OPACITY_H__
...
#define arm_2d_gray8_tile_fill_with_opacity_only(                               \
                                    __SRC_ADDR,     /*   source tile address */ \
                                    __DES_ADDR,     /*   target tile address */ \
                                    __REGION,       /*   region address */      \
                                    __OPACITY)      /*   opacity */             \
            arm_2dp_gray8_tile_fill_with_opacity_only(                          \
                                        NULL,                                   \
                                        (__SRC_ADDR),                           \
                                        (__DES_ADDR),                           \
                                        (__REGION),                             \
...
#define arm_2d_rgb565_tile_fill_with_opacity_only(                              \
                                    __SRC_ADDR,     /*   source tile address */ \
                                    __DES_ADDR,     /*   target tile address */ \
                                    __REGION,       /*   region address */      \
                                    __OPACITY)      /*   opacity */             \
            arm_2dp_rgb565_tile_fill_with_opacity_only(                         \
                                        NULL,                                   \
                                        (__SRC_ADDR),                           \
                                        (__DES_ADDR),                           \
                                        (__REGION),                             \
...
#define arm_2d_cccn888_tile_fill_with_opacity_only(                             \
                                    __SRC_ADDR,     /*   source tile address */ \
                                    __DES_ADDR,     /*   target tile address */ \
                                    __REGION,       /*   region address */      \
                                    __OPACITY)      /*   opacity */             \
            arm_2dp_cccn888_tile_fill_with_opacity_only(                        \
                                        NULL,                                   \
                                        (__SRC_ADDR),                           \
                                        (__DES_ADDR),                           \
                                        (__REGION),                             \
