...
#   define __ARM_2D_PIXEL_BLENDING_CCCA8888_TO_RGB565(  __SRC_ADDR,             \
    ...
    do {                                                                        \
        ...
        ARM_2D_SAFE_NAME(hwOPA) += (ARM_2D_SAFE_NAME(hwOPA) == 255);                                        \
        ARM_2D_SAFE_NAME(hwOPA) = ARM_2D_SAFE_NAME(hwOPA) * ((__TRANS) == 0)                                \
                + (ARM_2D_SAFE_NAME(hwOPA) * (256 - (__TRANS)) >> 8) * ((__TRANS) != 0);    \
        uint16_t ARM_2D_SAFE_NAME(hwTRANS) = 256 - ARM_2D_SAFE_NAME(hwOPA);                                 \
                                                                        \
        uint16_t *phwTargetPixel = (__DES_ADDR);                        \
        __arm_2d_rgb565_unpack(*phwTargetPixel, &ARM_2D_SAFE_NAME(tTargetPix));           \
                                                                        \
        for (int i = 0; i < 3; i++) {                                   \
            uint16_t        hwTemp =                                    \
                (uint16_t) (ARM_2D_SAFE_NAME(tSrcPix).BGRA[i] * ARM_2D_SAFE_NAME(hwOPA)) +                  \
                (ARM_2D_SAFE_NAME(tTargetPix).BGRA[i] * (ARM_2D_SAFE_NAME(hwTRANS)));                       \
            ARM_2D_SAFE_NAME(tTargetPix).BGRA[i] = (uint16_t) (hwTemp >> 8);              \
        }                                                               \
                                                                        \
        /* pack merged stream */                                        \
        *phwTargetPixel = __arm_2d_rgb565_pack(&ARM_2D_SAFE_NAME(tTargetPix));            \
    } while(0)
#endif
...
enum {
    ...
    __ARM_2D_OP_IDX_COPY_WITH_OPACITY_ONLY,
    __ARM_2D_OP_IDX_FILL_WITH_OPACITY_ONLY,
    ...
    __ARM_2D_OP_IDX_FILL_COLOUR_WITH_4PTS_ALPHA_GRADIENT,
    ...
    __ARM_2D_OP_IDX_FILL_COLOUR_WITH_HORIZONTAL_ALPHA_GRADIENT,
    __ARM_2D_OP_IDX_FILL_COLOUR_WITH_HORIZONTAL_ALPHA_GRADIENT_AND_MASK,
...
extern
arm_fsm_rt_t __arm_2d_gray8_sw_tile_fill_with_source_mask_and_opacity_only( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_tile_fill_with_source_mask_and_opacity_only( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_tile_fill_with_source_mask_and_opacity_only( 
                                                __arm_2d_sub_task_t *ptTask);
...
arm_fsm_rt_t __arm_2d_cccn888_sw_repeat_colour_filling_with_vertical_line_mask_and_opacity(
                                                __arm_2d_sub_task_t *ptTask);
extern
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_4pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_4pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_4pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_3pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_3pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_3pts_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_vertical_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_vertical_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_vertical_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_horizontal_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_horizontal_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_horizontal_alpha_gradient( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_4pts_alpha_gradient_and_mask( 
                                                __arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_4pts_alpha_gradient_and_mask( 
                                                __arm_2d_sub_task_t *ptTask);
...
extern
arm_fsm_rt_t __arm_2d_gray8_sw_tile_copy_with_opacity_only(__arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_rgb565_sw_tile_copy_with_opacity_only(__arm_2d_sub_task_t *ptTask);

extern
arm_fsm_rt_t __arm_2d_cccn888_sw_tile_copy_with_opacity_only(__arm_2d_sub_task_t *ptTask);
