...
#ifndef __ARM_2D_FILL_COLOUR_WITH_MASK_AND_MIRRORING_H__
#define __ARM_2D_FILL_COLOUR_WITH_MASK_AND_MIRRORING_H__
...
#define arm_2d_gray8_fill_colour_with_mask_and_x_mirror(                        \
...
#define arm_2d_gray8_fill_colour_with_mask_x_mirror_and_opacity(                \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_and_y_mirror(                        \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_y_mirror_and_opacity(                \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_and_xy_mirror(                       \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_xy_mirror_and_opacity(               \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_only(                                \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_gray8_fill_colour_with_mask_and_opacity_only(                    \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
        ...
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_gray8_fill_colour_with_mask_only(                  \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
        ...
        case ARM_2D_CP_MODE_X_MIRROR:                                           \
            tResult = arm_2d_gray8_fill_colour_with_mask_and_x_mirror(          \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
        ...
        case ARM_2D_CP_MODE_Y_MIRROR:                                           \
            tResult = arm_2d_gray8_fill_colour_with_mask_and_y_mirror(          \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
        ...
        case ARM_2D_CP_MODE_XY_MIRROR:                                          \
            tResult = arm_2d_gray8_fill_colour_with_mask_and_xy_mirror(         \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
           &    ARM_2D_CP_MODE_XY_MIRROR) {                                     \
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_gray8_fill_colour_with_mask_and_opacity_only(      \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR),                                         \
...
#define arm_2d_rgb565_fill_colour_with_mask_and_y_mirror(                       \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_rgb565_fill_colour_with_mask_y_mirror_and_opacity(               \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_rgb565_fill_colour_with_mask_and_xy_mirror(                      \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_rgb565_fill_colour_with_mask_xy_mirror_and_opacity(              \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_rgb565_fill_colour_with_mask_only(                               \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_rgb565_fill_colour_with_mask_and_opacity_only(                   \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
           &    ARM_2D_CP_MODE_XY_MIRROR) {                                     \
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_rgb565_fill_colour_with_mask_only(                 \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_X_MIRROR:                                           \
            tResult = arm_2d_rgb565_fill_colour_with_mask_and_x_mirror(         \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_Y_MIRROR:                                           \
            tResult = arm_2d_rgb565_fill_colour_with_mask_and_y_mirror(         \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_XY_MIRROR:                                          \
            tResult = arm_2d_rgb565_fill_colour_with_mask_and_xy_mirror(        \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
           &    ARM_2D_CP_MODE_XY_MIRROR) {                                     \
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_rgb565_fill_colour_with_mask_and_opacity_only(     \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR),                                         \
...
#define arm_2d_cccn888_fill_colour_with_mask_and_x_mirror(                      \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_x_mirror_and_opacity(              \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_and_y_mirror(                      \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_y_mirror_and_opacity(              \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_and_xy_mirror(                     \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_xy_mirror_and_opacity(             \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_only(                              \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR)       /*   colour */              \
...
#define arm_2d_cccn888_fill_colour_with_mask_and_opacity_only(                  \
                                    __TARGET_ADDR,  /*   target tile address*/  \
                                    __REGION_ADDR,  /*   target region address*/\
                                    __ALPHA_ADDR,   /*   alpha tile address */  \
                                    __COLOUR,       /*   colour */              \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
           &    ARM_2D_CP_MODE_XY_MIRROR) {                                     \
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_cccn888_fill_colour_with_mask_only(                \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_X_MIRROR:                                           \
            tResult = arm_2d_cccn888_fill_colour_with_mask_and_x_mirror(        \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_Y_MIRROR:                                           \
            tResult = arm_2d_cccn888_fill_colour_with_mask_and_y_mirror(        \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
            break;                                                              \
        case ARM_2D_CP_MODE_XY_MIRROR:                                          \
            tResult = arm_2d_cccn888_fill_colour_with_mask_and_xy_mirror(       \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR));                                        \
...
({                                                                              \
    ...
    switch (    (ARM_2D_CP_MODE_NO_MIRROR, ##__VA_ARGS__)                       \
           &    ARM_2D_CP_MODE_XY_MIRROR) {                                     \
        case ARM_2D_CP_MODE_NO_MIRROR:                                          \
            tResult = arm_2d_cccn888_fill_colour_with_mask_and_opacity_only(    \
                            (__TARGET_ADDR),                                    \
                            (__REGION_ADDR),                                    \
                            (__SRC_MSK_ADDR),                                   \
                            (__COLOUR),                                         \
