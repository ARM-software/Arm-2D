...
/*============================ MACROFIED FUNCTIONS ===========================*/
#define MASK_COLOR(sz)  (   (sz == 8)                                           \
                        ? ptInfo->Mask.chColour                                 \
                        :   (   (sz == 16)                                      \
                            ?   ptInfo->Mask.hwColour                           \
                            :   ptInfo->Mask.wColour))
...
__STATIC_INLINE
void __cl_with_trans_msk_des_msk_get_alpha_with_opacity( 
                                            ...
                                            uint_fast16_t hwOpacity)
{
    ...
    if (wTotalAlpha) {
        ...
        __ARM_2D_PIXEL_BLENDING_OPA_RGB565( &hwMaskColour, pTarget, hwAlpha);
    }
    ...
    uint32_t wPixelAlpha = 0;
    //if (arm_2d_is_point_inside_region(ptOrigValidRegion, &tPoint)) {
        wPixelAlpha = pchOrigin[   tPoint.iY * iOrigStride
                                     +   tPoint.iX];
        ...
        __ARM_2D_PIXEL_BLENDING_OPA_RGB565( &hwMaskColour, pTarget, wPixelAlpha);
    //}
                                    ...
                                    uint_fast16_t chOpacity)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __cl_with_trans_msk_des_msk_get_alpha_with_opacity (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
