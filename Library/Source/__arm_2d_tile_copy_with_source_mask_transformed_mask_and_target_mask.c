 ...
 * Title:        __arm_2d_tile_copy_with_source_mask_transformed_mask_and_target_mask.c
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_gray8_tile_copy_with_source_mask_transformed_mask_and_target_mask_prepare(
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_GRAY8;
...
__STATIC_INLINE
void __gray8_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point( 
                                    ...
                                    __arm_2d_transform_info_t *ptInfo)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __gray8_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_gray8_sw_tile_copy_with_source_mask_transformed_mask_and_target_mask);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_GRAY8 = {
    .Info = {
        .Colour = {
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_gray8_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_prepare(
                                        arm_2d_op_tile_cp_src_msk_trans_msk_des_msk_opa_t *ptOP,
                                        const arm_2d_tile_t *ptSource,
                                        const arm_2d_tile_t *ptSourceMask,
                                        const arm_2d_tile_t *ptTransMask,
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_GRAY8;
...
__STATIC_INLINE
void __gray8_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point( 
                                            arm_2d_point_fx_t  *ptFxPoint,
                                            arm_2d_region_t *ptOrigValidRegion,
                                            uint8_t *pchOrigin,
                                            int16_t iOrigStride,
                                    ...
                                    uint_fast16_t chOpacity)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __gray8_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_gray8_sw_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_GRAY8 = {
    .Info = {
        .Colour = {
            .chScheme               = ARM_2D_COLOUR_GRAY8,
        },
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_rgb565_tile_copy_with_source_mask_transformed_mask_and_target_mask_prepare(
                                        arm_2d_op_tile_cp_src_msk_trans_msk_des_msk_opa_t *ptOP,
                                        const arm_2d_tile_t *ptSource,
                                        const arm_2d_tile_t *ptSourceMask,
                                        const arm_2d_tile_t *ptTransMask,
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_RGB565;
...
__STATIC_INLINE
void __rgb565_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point( 
                                            arm_2d_point_fx_t  *ptFxPoint,
                                            arm_2d_region_t *ptOrigValidRegion,
                                            uint8_t *pchOrigin,
                                            int16_t iOrigStride,
                                    ...
                                    __arm_2d_transform_info_t *ptInfo)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __rgb565_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_rgb565_sw_tile_copy_with_source_mask_transformed_mask_and_target_mask);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_RGB565 = {
    .Info = {
        .Colour = {
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_rgb565_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_prepare(
                                        arm_2d_op_tile_cp_src_msk_trans_msk_des_msk_opa_t *ptOP,
                                        const arm_2d_tile_t *ptSource,
                                        const arm_2d_tile_t *ptSourceMask,
                                        const arm_2d_tile_t *ptTransMask,
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_RGB565;
...
__STATIC_INLINE
void __rgb565_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point( 
                                            arm_2d_point_fx_t  *ptFxPoint,
                                            arm_2d_region_t *ptOrigValidRegion,
                                            uint8_t *pchOrigin,
                                            int16_t iOrigStride,
                                    ...
                                    uint_fast16_t chOpacity)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __rgb565_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_rgb565_sw_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_RGB565 = {
    .Info = {
        .Colour = {
            .chScheme               = ARM_2D_COLOUR_RGB565,
        },
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_cccn888_tile_copy_with_source_mask_transformed_mask_and_target_mask_prepare(
                                        arm_2d_op_tile_cp_src_msk_trans_msk_des_msk_opa_t *ptOP,
                                        const arm_2d_tile_t *ptSource,
                                        const arm_2d_tile_t *ptSourceMask,
                                        const arm_2d_tile_t *ptTransMask,
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_CCCN888;
...
__STATIC_INLINE
void __cccn888_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point( 
                                            arm_2d_point_fx_t  *ptFxPoint,
                                            arm_2d_region_t *ptOrigValidRegion,
                                            uint8_t *pchOrigin,
                                            int16_t iOrigStride,
                                    ...
                                    __arm_2d_transform_info_t *ptInfo)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __cccn888_tile_copy_with_source_mask_transformed_mask_and_target_mask_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_cccn888_sw_tile_copy_with_source_mask_transformed_mask_and_target_mask);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_AND_TARGET_MASK_CCCN888 = {
    .Info = {
        .Colour = {
...
ARM_NONNULL(2,3,4,5)
arm_2d_err_t arm_2dp_cccn888_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_prepare(
                                        arm_2d_op_tile_cp_src_msk_trans_msk_des_msk_opa_t *ptOP,
                                        const arm_2d_tile_t *ptSource,
                                        const arm_2d_tile_t *ptSourceMask,
                                        const arm_2d_tile_t *ptTransMask,
...
//#endif
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_CCCN888;
...
__STATIC_INLINE
void __cccn888_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point( 
                                            arm_2d_point_fx_t  *ptFxPoint,
                                            arm_2d_region_t *ptOrigValidRegion,
                                            uint8_t *pchOrigin,
                                            int16_t iOrigStride,
                                    ...
                                    uint_fast16_t chOpacity)
{
    ...
    for (int_fast16_t y = 0; y < iHeight; y++) {
        ...
        for (int_fast16_t x = 0; x < iWidth; x++) {
            ...
            __cccn888_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity_process_point (
                            &tPointFast,
                            ptOriginValidRegion,
                            pchOrigin,
                            iOrigStride,
...
def_low_lv_io(  
    ...
    __arm_2d_cccn888_sw_tile_copy_with_source_mask_transformed_mask_target_mask_and_opacity);   /* Default SW Implementation */

/*
 * OPCODE
 */
const __arm_2d_op_info_t 
ARM_2D_OP_TILE_COPY_WITH_SOURCE_MASK_TRANSFORMED_MASK_TARGET_MASK_AND_OPACITY_CCCN888 = {
    .Info = {
        .Colour = {
            .chScheme               = ARM_2D_COLOUR_CCCN888,
        },
